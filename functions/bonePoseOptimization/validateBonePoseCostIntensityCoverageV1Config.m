function [fixedParameters, hyperparameters] = ...
...
validateFieldNames(fixedParameters, {'intensityMax'}, ...
...
hyperparameters.minReferencePixels = normalizeCandidates( ...
    hyperparameters.minReferencePixels, ...
    'cost.hyperparameters.minReferencePixels', true);
hyperparameters.nMinPixels = normalizeCandidates( ...
    hyperparameters.nMinPixels, ...
    'cost.hyperparameters.nMinPixels', true);
hyperparameters.lambdaMissing = normalizeCandidates( ...
    hyperparameters.lambdaMissing, ...
    'cost.hyperparameters.lambdaMissing', false);
end
