...
validateattributes(schemaVersion, {'numeric'}, {'scalar', 'real', 'finite', 'integer'}, mfilename, 'schemaVersion');
if schemaVersion ~= 4
...
targetBone = upper(ensureScalarText(getRequiredField(rawConfig.input, 'bone', 'input.bone'), 'input.bone'));
...
config.intersection.normalFacingToleranceDeg = getRequiredField( ...
    rawConfig.intersection, 'normalFacingToleranceDeg', 'intersection.normalFacingToleranceDeg');
