...
%                   and output paths, the two MAT-file names, and the
%                   Boolean result-saving choice.
...
saveResult = requireConfigurationBoolean( ...
    outputConfiguration, 'saveResult', 'output.saveResult', ...
    errorNamespace);
