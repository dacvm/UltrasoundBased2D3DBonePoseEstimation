...
femurEpicondyle_proximalOffset_mm = 10;
...
femurEpicondyle_anteriorAngleOffset_deg = 20;
...
tibiaCondyle_distalOffset_mm = 10;
...
tibiaCondyle_anteriorAngleOffset_deg = 25;
...
if ~isnumeric(femurEpicondyle_proximalOffset_mm) || ...
        ~isscalar(femurEpicondyle_proximalOffset_mm) || ...
        ~isreal(femurEpicondyle_proximalOffset_mm) || ...
        ~isfinite(femurEpicondyle_proximalOffset_mm) || ...
        femurEpicondyle_proximalOffset_mm < 0
    error('bonePreRegistration:InvalidFemurProximalOffset', ...
        'femurEpicondyle_proximalOffset_mm must be one finite, nonnegative number.');
end
...
if ~isnumeric(femurEpicondyle_anteriorAngleOffset_deg) || ...
        ~isscalar(femurEpicondyle_anteriorAngleOffset_deg) || ...
        ~isreal(femurEpicondyle_anteriorAngleOffset_deg) || ...
        ~isfinite(femurEpicondyle_anteriorAngleOffset_deg) || ...
        femurEpicondyle_anteriorAngleOffset_deg < 0 || ...
        femurEpicondyle_anteriorAngleOffset_deg >= 90
    error('bonePreRegistration:InvalidFemurAnteriorAngleOffset', ...
        'femurEpicondyle_anteriorAngleOffset_deg must be one finite number in the range [0, 90) degrees.');
end
...
if ~isnumeric(tibiaCondyle_distalOffset_mm) || ...
        ~isscalar(tibiaCondyle_distalOffset_mm) || ...
        ~isreal(tibiaCondyle_distalOffset_mm) || ...
        ~isfinite(tibiaCondyle_distalOffset_mm) || ...
        tibiaCondyle_distalOffset_mm < 0
    error('bonePreRegistration:InvalidTibiaDistalOffset', ...
        'tibiaCondyle_distalOffset_mm must be one finite, nonnegative number.');
end
...
if ~isnumeric(tibiaCondyle_anteriorAngleOffset_deg) || ...
        ~isscalar(tibiaCondyle_anteriorAngleOffset_deg) || ...
        ~isreal(tibiaCondyle_anteriorAngleOffset_deg) || ...
        ~isfinite(tibiaCondyle_anteriorAngleOffset_deg) || ...
        tibiaCondyle_anteriorAngleOffset_deg < 0 || ...
        tibiaCondyle_anteriorAngleOffset_deg >= 90
    error('bonePreRegistration:InvalidTibiaAnteriorAngleOffset', ...
        'tibiaCondyle_anteriorAngleOffset_deg must be one finite number in the range [0, 90) degrees.');
end
...
point_femurLineOrigin_CT = point_femurAcsOrigin_CT + femurEpicondyle_proximalOffset_mm * vector_femurY_CT;
...
vector_femurNegativeZRay_CT = normalizeVector( ...
    sind(femurEpicondyle_anteriorAngleOffset_deg) * vector_femurX_CT - ...
    cosd(femurEpicondyle_anteriorAngleOffset_deg) * vector_femurZ_CT, ...
...
point_tibiaLineOrigin_CT = point_tibiaAcsOrigin_CT - tibiaCondyle_distalOffset_mm * vector_tibiaY_CT;
...
vector_tibiaNegativeZRay_CT = normalizeVector( ...
    sind(tibiaCondyle_anteriorAngleOffset_deg) * vector_tibiaX_CT - ...
    cosd(tibiaCondyle_anteriorAngleOffset_deg) * vector_tibiaZ_CT, ...
...
% Store each pair in the fixed row order [medial; lateral] and retain both
% user settings so a saved landmark file records how each pair was created.
landmarks(1).distalOffset_mm = 0;
landmarks(1).proximalOffset_mm = femurEpicondyle_proximalOffset_mm;
landmarks(1).anteriorAngleOffset_deg = femurEpicondyle_anteriorAngleOffset_deg;
...
landmarks(2).distalOffset_mm = tibiaCondyle_distalOffset_mm;
landmarks(2).proximalOffset_mm = 0;
landmarks(2).anteriorAngleOffset_deg = tibiaCondyle_anteriorAngleOffset_deg;
...
intersectionDiagnostics(1).proximalOffset_mm  = femurEpicondyle_proximalOffset_mm;
intersectionDiagnostics(1).anteriorAngleOffset_deg = femurEpicondyle_anteriorAngleOffset_deg;
intersectionDiagnostics(1).lineOrigin         = point_femurLineOrigin_CT;
intersectionDiagnostics(1).lineDirection      = vectors_femurRayDirections_CT;
...
intersectionDiagnostics(2).distalOffset_mm    = tibiaCondyle_distalOffset_mm;
intersectionDiagnostics(2).proximalOffset_mm  = 0;
intersectionDiagnostics(2).anteriorAngleOffset_deg = tibiaCondyle_anteriorAngleOffset_deg;
...
fprintf('Femoral landmark width at %.2f mm proximal and %.2f deg anterior: %.2f mm\n', ...
    femurEpicondyle_proximalOffset_mm, femurEpicondyle_anteriorAngleOffset_deg, ...
    norm(point_femurLateral_CT - point_femurMedial_CT));
fprintf('Tibial landmark width at %.2f mm distal and %.2f deg anterior: %.2f mm\n', ...
    tibiaCondyle_distalOffset_mm, tibiaCondyle_anteriorAngleOffset_deg, ...
...
title(axes_landmarks, sprintf( ...
    ['%s knee landmarks | femur %.1f mm proximal, %.1f deg | ', ...
     'tibia %.1f mm distal, %.1f deg'], ...
    upper(kneeSide), femurEpicondyle_proximalOffset_mm, ...
    femurEpicondyle_anteriorAngleOffset_deg, ...
    tibiaCondyle_distalOffset_mm, tibiaCondyle_anteriorAngleOffset_deg));
